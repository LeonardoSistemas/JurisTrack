const API_URL = '/api/auxiliares/probabilidades'
const ID_CAMPO = 'idprobabilidade'
...
async function carregar() {
    try {
        ...
        tbody.innerHTML = dados.map(item => {
            ...
            const idProbabilidades = item.idprobabilidade || item.IdProbabilidade || item.idProbabilidade;
            ...
            <tr>
                ...
                <td class="text-end">
                    <button class="btn btn-sm btn-outline-secondary" 
                        onclick="editar('${idProbabilidades}', '${item.descricao}', ${item.ativo})">
