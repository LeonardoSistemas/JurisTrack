const API_URL = '/api/auxiliares/tipos_acao'
const ID_CAMPO = 'idtipoacao'
...
async function carregar() {
    try {
        ...
        tbody.innerHTML = dados.map(item => {
            ...
            const idtipoAcao = item.idtipoacao || item.IdTipoacao || item.IdTipoacao;
            ...
            <tr>
                ...
                <td class="text-end">
                    <button class="btn btn-sm btn-outline-secondary" 
                        onclick="editar('${idtipoAcao}', '${item.descricao}', ${item.ativo})">
