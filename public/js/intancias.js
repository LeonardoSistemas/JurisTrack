const API_URL = '/api/auxiliares/instancias';
const ID_CAMPO = 'idinstancia';
...
async function carregar() {
    try {
        ...
        tbody.innerHTML = dados.map(item => {
            ...
            // BLINDAGEM: Lê o ID correto (Minúsculo ou Maiúsculo)
            const idReal = item.idinstancia || item.IdInstancia;
            ...
            <tr>
                ...
                <td class="text-end">
                    <button class="btn btn-sm btn-outline-secondary" 
                        onclick="editar('${idReal}', '${item.descricao}', ${item.ativo})">
