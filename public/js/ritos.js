const API_URL = '/api/auxiliares/ritos'
const ID_CAMPO = 'idrito'
...
async function carregar() {
    try {
        ...
        tbody.innerHTML = dados.map(item => {
            ...
            const idRitos = item.idrito || item.IdRito || item.idRito;
            ...
            <tr>
                ...
                <td class="text-end">
                    <button class="btn btn-sm btn-outline-secondary" 
                        onclick="editar('${idRitos}', '${item.descricao}', ${item.ativo})">
